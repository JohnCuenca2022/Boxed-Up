...
import { getAuth, onAuthStateChanged, connectAuthEmulator, GoogleAuthProvider, FacebookAuthProvider, 
  createUserWithEmailAndPassword, sendSignInLinkToEmail, RecaptchaVerifier, } from 'https://www.gstatic.com/firebasejs/9.6.7/firebase-auth.js';
...
document.getElementById("signup").addEventListener('click', (e) => {
    ...
    if (email==="" || email===null){
      ...
      .then(() => {
        ...
        SuccessOkPopUp('Email Verification Sent', 'Please check your email to proceed');
      })
      .catch((error) => {
        const errorCode = error.code;
            if (errorCode === "auth/invalid-email"){
              ...
              errorOkPopUp('Email Failed to Send', 'An error has occured in sending your email');
            }
      });
      isCaptchaVerified = false;
